  ...
  return (
    <ScrollReveal>
      <main className="shell sheetdoc-page magnet-print-root">
        <header className="page-hero sheetdoc-hero" data-motion>
        ...
        <section className="panel magnet-panel magnet-no-print" aria-labelledby="magnet-title" data-motion>
        ...
        >
          ...
          <p className="sheetdoc-print-note">Print / Save as PDF from browser</p>
        </section>

        <div className="sheetdoc-list">
          {cheatSheets.map((sheet, index) => (
            <article key={sheet.slug} id={sheet.slug} className="panel sheetdoc-sheet" data-motion>
              ...
              <CheatsheetSections sheet={sheet} />
            </article>
          ))}
        </div>

        <aside className="panel sheetdoc-cta" aria-labelledby="sheetdoc-cta-title" data-motion>
          <div>
